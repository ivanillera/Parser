...
assert lexer("si senior else eof") == [('ID', 'si'), ('ID', 'senior'), ('_ELSE', 'else'), ('_EOF', 'eof'),('_EOF','EOF')]
assert lexer("420 >= 200") == [('ID', '420'), ('_BIGOREQUAL', '>='), ('ID', '200'),('_EOF','EOF')]
assert lexer("if ifno ifyes") == [('_IF', 'if'), ('ID', 'ifno'), ('ID', 'ifyes'),('_EOF','EOF')]
